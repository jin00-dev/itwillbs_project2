...
<body>
	...
	<form action="/user/join" method="get">
		<div class="form-group">
			<label>회원 약관</label>
			<textarea rows="10" class="form-control" readonly="readonly">회원 약관에는 회원이 꼭 알아두어야 할 회사와 회원의 관계에 대한 중요한 내용이 포함되어 있습니다.
...
세모클래스의 개인정보보호와 관련된 정책을 알고 싶은 분은 [개인정보 취급방침]을 클릭하세요.
		...
		<label><input type="checkbox" required="required" title="약관에 동의하셔야 회원가입이 가능합니다.">
		약관에 동의합니다</label>
		</div>
		<button class="btn btn-default">가입하러가기</button>
	</form>
	</div>
</body>
</html>