...
//	public PaymentVO getPaymentInfo(String accessToken, PayDTO pdto) {
//		PaymentVO paymentInfo = new PaymentVO(); // payDTO에서 수정
...
//		return dao.modifyOrder(order_num);
//	}

	public PaymentVO selectPayInfo(int order_num) throws Exception {
		return dao.selectPayInfo(order_num);
	}

	public PaymentVO getCancelInfo(String accessToken, PaymentVO rvo) throws Exception {
