...
//	
	...
	public HashMap<String, Object> checkEmail(String user_id){
		HashMap<String, Object> data = new HashMap<String, Object>();
		...
		// 보내는 사람
		String from = "kimseo131612@gmail.com";
		...
		try {
			...
			// 메일 내용을 채워줌
			mailHelper.setFrom(from, "관리자");  //보내는사람
			mailHelper.setTo(user_id);		//받는사람
